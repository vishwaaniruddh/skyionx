...
const specs = {
  wireless: [
    { label: 'Standard Bandwidth', value: 'IEEE802.11n/ac standard, up to 1200Mbps' },
    { label: 'Safety/Security', value: 'Supports WEP, WAP, WPA2, WPA3, Enterprise 802.1x' },
    { label: 'Transmitted Power', value: '20 dBm (11g/n/ac)' },
    { label: 'Receive Sensitivity', value: '<-76 dBm @ 54 Mbps' },
  ],
  interface: [
    { label: 'LAN', value: '4 Gigabit LAN interfaces, Full Duplex 10/100/1000 Mbit/s' },
    { label: 'WAN', value: '1 Gigabit WAN interface' },
    { label: 'SIM/UIM', value: 'Dual SIM slot with auto-failover, 1.8V/3V auto detection' },
    { label: 'Power Source', value: 'DC 12V/2A' },
  ],
  environment: [
    ...
    { label: 'Voltage Range', value: 'DC 12V/2A' },
  ]
}

export default function Asb90Page() {
    ...
    <div className="min-h-screen pb-20">
      ...
      <section ref={heroRef} className="relative h-[60vh] min-h-[400px] flex items-center justify-center overflow-hidden">
        <motion.div className="absolute inset-0 z-0" style={{ y: heroY }}>
          <img src="/images/products/asb90-hero.png" alt="ASB90 Router" className="w-full h-[120%] object-cover" />
        ...
        <motion.div className="relative z-10 text-center" style={{ opacity: heroOpacity }}>
          ...
          <motion.h1 initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4, duration: 0.7 }} className="text-4xl lg:text-6xl font-bold font-heading">
            ASB90 <span className="gradient-text">Industrial Router</span>
          </motion.h1>
        </motion.div>
      </section>
      ...
      <div className="site-container -mt-10 lg:-mt-20 relative z-20">
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-8 space-y-12">
            ...
            >
              <img 
                src="/images/products/ASB90.png" 
                alt="ASB90 Industrial Router" 
            ...
            >
              ...
              <h2 className="text-2xl lg:text-3xl font-bold font-heading mb-6">Enterprise Grade <span className="gradient-text">Connectivity</span></h2>
              <p className="text-gray-400 text-lg leading-relaxed mb-8">
                The most powerful industrial router in our lineup, designed for mission-critical enterprise environments. ASB90 delivers ultra-fast 5G speeds, multi-WAN load balancing, and advanced security protocols. Featuring 4 Gigabit LAN ports and dual SIM capabilities, it ensures maximum uptime for large-scale deployments and heavy-duty applications.
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  ...
                  <ul className="space-y-2 text-gray-400">
                    {['Enterprise Headquarters', 'Manufacturing Plants', 'Large Retail Chains', 'High-Density IoT Deployments'].map(item => (
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-gray-400">
                    {[
                      'Advanced Security & IPSEC VPN',
                      'Multi-WAN Load Balancing',
                      'Dual SIM card support with auto-failover',
                      '4 Gigabit Ethernet ports',
                      'High-speed 5G integration',
                      'Real time centralized monitoring',
                      'Ruggedized enclosure for harsh environments',
                    ].map(item => (
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            >
              <div className="bg-navy-900 rounded-xl p-6 border border-white/5 text-center mb-6">
                <h3 className="text-2xl font-bold font-heading text-white mb-2">ASB90</h3>
                <p className="text-sm text-cyan-400">Enterprise 5G Edge Router</p>
              </div>
