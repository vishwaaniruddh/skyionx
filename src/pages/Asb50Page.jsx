...
const specs = {
  wireless: [
    { label: 'Standard Bandwidth', value: 'IEEE802.11n standard, 150Mbps' },
  ...
  interface: [
    { label: 'LAN', value: '3 LAN interface, Built-in electromagnetic isolation, Full Duplex 10/100 Mbit/s' },
    { label: 'WAN', value: '1 WAN/LAN interface multiplex, Console Port' },
    { label: 'SIM/UIM', value: 'Dual SIM support with shed protection, 1.8V/3V auto detection' },
    { label: 'GPS', value: 'SMA-type GPS antenna port' },
    { label: 'Power Source', value: 'DC 12V/1.5A' },
  ],
  environment: [
    ...
    { label: 'Voltage Range', value: 'DC 12V/1.5A' },
  ]
}

export default function Asb50Page() {
    ...
    <div className="min-h-screen pb-20">
      ...
      <section ref={heroRef} className="relative h-[60vh] min-h-[400px] flex items-center justify-center overflow-hidden">
        <motion.div className="absolute inset-0 z-0" style={{ y: heroY }}>
          <img src="/images/products/asb50-hero.png" alt="ASB50 Router" className="w-full h-[120%] object-cover" />
        ...
        <motion.div className="relative z-10 text-center" style={{ opacity: heroOpacity }}>
          ...
          <motion.h1 initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4, duration: 0.7 }} className="text-4xl lg:text-6xl font-bold font-heading">
            ASB50 <span className="gradient-text">Industrial Router</span>
          </motion.h1>
        </motion.div>
      </section>
      ...
      <div className="site-container -mt-10 lg:-mt-20 relative z-20">
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-8 space-y-12">
            ...
            >
              <img 
                src="/images/products/ASB50.png" 
                alt="ASB50 Industrial Router" 
            ...
            >
              ...
              <h2 className="text-2xl lg:text-3xl font-bold font-heading mb-6">High-Performance <span className="gradient-text">Networking</span></h2>
              <p className="text-gray-400 text-lg leading-relaxed mb-8">
                High-performance networking solution designed to support secure communication and scalable connectivity requirements. ASB50 is an industrial grade 4G LTE and 5G router with IoT capabilities and speeds up to 150mbps, along with support for dual SIM and GPS. Ideal for fleet management, remote monitoring, and M2M applications.
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  ...
                  <ul className="space-y-2 text-gray-400">
                    {['BFSI Sector', 'Government Networks', 'Smart Cities', 'Enterprise Infrastructure'].map(item => (
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-gray-400">
                    {[
                      ...
                      'Standard speeds up to 150Mbps',
                      'Support for FDD-LTE Bands 1/2/3/4/5/7/8/20, TDD-LTE Bands 38/39/40/41'
                    ].map(item => (
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            >
              <div className="bg-navy-900 rounded-xl p-6 border border-white/5 text-center mb-6">
                <h3 className="text-2xl font-bold font-heading text-white mb-2">ASB50</h3>
